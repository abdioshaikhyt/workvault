...
CELERY_TASK_ROUTES = {
    'backend1app.tasks.*': {'queue': 'backend1'},
}

CELERY_BEAT_SCHEDULE = {
    'flush-blacklisted-access-tokens-daily': {
        'task': 'backend1app.tasks.delete_all_logout_tokens',
        'schedule': crontab(hour=23, minute=59),
        'options': {'queue': 'backend1'},   
    },
}
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE1_NAME'),
        'USER': os.getenv('DATABASE1_USER'),
